    ...
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        ...
        <p className="max-w-2xl text-base md:text-xl text-neutral-300 leading-relaxed">
          Kami menyediakan layanan IT komprehensif untuk membantu bisnis dan individu dengan kebutuhan teknologi mereka.
          Dari perakitan PC hingga pengembangan website, kami adalah partner teknologi Anda.
        </p>
        <motion.div
          className="mt-12"
        ...
        >
          <a
            href="#services"
            className="inline-flex items-center px-8 py-4 bg-white hover:bg-slate-700 text-black font-semibold rounded-lg transition-colors duration-300"
          >
            Lihat Layanan Kami
