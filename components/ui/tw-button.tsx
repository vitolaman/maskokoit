...
import { ButtonsCard } from "./tailwind-button";
...
export const buttons = [
  ...
  },
  {
    ...
    component: (
      <button className="px-8 py-2 rounded-full bg-gradient-to-b from-blue-500 to-blue-600 text-white focus:ring-2 focus:ring-white hover:shadow-xl transition duration-200">
        Gradient
      </button>
    ),
  },
