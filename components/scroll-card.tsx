    ...
    <ReactLenis root>
      <main>
        <article>
          ...
          <section className="text-white  h-screen  w-full bg-[#253031]  grid place-content-center sticky top-0">
            <div className="flex gap-8 px-4 md:px-24 z-50">
              <img
                src="/ihgma.png"
                width={800}
                height={450}
          ...
          <section className="bg-gray-300 text-black grid place-content-center h-screen sticky top-0 rounded-tr-2xl rounded-tl-2xl overflow-hidden">
            <div className="flex gap-8 px-4 md:px-24">
              <div className="flex flex-col items-start gap-4 w-1/3 text-right">
                <h1 className="2xl:text-7xl text-4xl font-semibold tracking-tight leading-[120%]">
                  In-n-Out Car Wash
                </h1>
                <h1 className="text-2xl">
          ...
          <section className="text-white  h-screen  w-full bg-[#122932]  grid place-content-center sticky top-0">
            <div className="flex gap-8 px-4 md:px-24 z-50">
              <img
                src="/cgm11.png"
                width={800}
